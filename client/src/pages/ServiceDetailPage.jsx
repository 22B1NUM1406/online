...
const ServiceDetailPage = () => {
  ...
  // Prepare share data
  const shareUrl = `https://www.bizco.mn/services/${service.slug}`;
  ...
  const shareImage = getImageUrl(service.image) || 'https://www.bizco.mn/images/default-service.jpg';
              ...
              <div className="sticky top-4 space-y-6">
                ...
                <div className="bg-gradient-to-br from-purple-600 to-pink-600 text-white rounded-2xl shadow-lg p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <a 
                      href="mailto:bizprintpro@gmail.com"
                      className="flex items-center gap-3 p-3 bg-white/20 rounded-lg hover:bg-white/30 transition-colors"
                    >
                      <Mail size={20} />
